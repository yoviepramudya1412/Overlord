...
b.aanFeatures.i&&"api"!==a.select.style()){var c=a.rows({selected:!0}).flatten().length,d=a.columns({selected:!0}).flatten().length,e=a.cells({selected:!0}).flatten().length,g=function(f,k,l){f.append(h('<span class="select-item"/>').append(a.i18n("выбрано"+k+"s",{_:"%d "+k+"s выбрано",0:"",1:"1 "+k+" выбрана"},l)))};h.each(b.aanFeatures.i,function(f,k){k=h(k);f=h('<span class="select-info p-1"/>');g(f,"элемент",c);g(f,"столбец",d);g(f,"клетка",e);var l=k.children("span.select-info");l.length&&l.remove();
